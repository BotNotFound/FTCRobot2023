package org.firstinspires.ftc.teamcode.modules.computervision.testing.pipeline;
...
public class SimColorMassDetectionProcessor implements VisionProcessor {
    ...
    public SimColorMassDetectionProcessor() {
        this.contours = new ArrayList<>();
        this.lower = new Scalar(0, 0, 150); // the lower hsv threshold for your detection
        this.upper = new Scalar(180, 72, 255); // the upper hsv threshold for your detection
        this.minArea = () -> 50;
