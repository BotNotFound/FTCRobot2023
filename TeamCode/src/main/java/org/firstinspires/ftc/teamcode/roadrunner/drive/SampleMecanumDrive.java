...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.14165;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap/*, Localizer localizer*/) {
        ...
        imu = hardwareMap.get(IMU.class, FieldCentricDriveTrain.IMU_NAME);
        imu.initialize(FieldCentricDriveTrain.getImuParameters());

        leftFront = hardwareMap.get(DcMotorEx.class, DriveTrain.FRONT_LEFT_MECANUM_DRIVER_DEFAULT_NAME);
        leftRear = hardwareMap.get(DcMotorEx.class, DriveTrain.BACK_LEFT_MECANUM_DRIVER_DEFAULT_NAME);
        rightRear = hardwareMap.get(DcMotorEx.class, DriveTrain.BACK_RIGHT_MECANUM_DRIVER_DEFAULT_NAME);
        rightFront = hardwareMap.get(DcMotorEx.class, DriveTrain.FRONT_RIGHT_MECANUM_DRIVER_DEFAULT_NAME);
        ...
        DriveTrain.configureMotorDirections(leftFront, rightFront, leftRear, rightRear);
