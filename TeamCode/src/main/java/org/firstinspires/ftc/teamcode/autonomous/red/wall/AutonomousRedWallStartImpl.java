...
public abstract class AutonomousRedWallStartImpl extends AutonomousRedImpl {
    public static final String RED_WALL_AUTO_GROUP_NAME = RED_AUTO_GROUP_NAME + " | Backdrop";
